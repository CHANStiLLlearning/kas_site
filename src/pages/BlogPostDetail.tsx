  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        {/* Featured Image */}
        <div className="mb-12 rounded-4xl overflow-hidden shadow-2xl h-112.5">
          <img 
            src={post.image} 
            alt={post.title} 
        ...
        {/* Footer info */}
        <div className="mt-20 p-12 bg-[#F8FAFC] rounded-3xl border border-slate-100 flex flex-col md:flex-row items-center gap-8 shadow-sm">
